...
## DB is accepting connection from backend, bastion and vpn
...
## Backend is accepting connection from app_alb, bastion and vpn
...
## app alb is accepting connection from vpn, bastion and frontend
...
## Frontend is accepting connection from web_alb, bastion, vpn and public
resource "aws_security_group_rule" "frontend_web_alb" {
    type           = "ingress"
    from_port      = 80
    to_port        = 80
    protocol       = "tcp"
    source_security_group_id = module.web_alb.sg_id #source is from where you are getting traffic  
...
#   to_port          = 22
#   protocol         = "tcp"
#   cidr_blocks      = ["0.0.0.0/0"] #no source for frontend public
#   security_group_id = module.frontend.sg_id
# }

## web alb accepting connections from public http and public https
...
resource "aws_security_group_rule" "bastion_public" {
    ...
    to_port         = 22
    protocol        = "tcp"
    cidr_blocks     = ["0.0.0.0/0"] #no source for bastion public  
